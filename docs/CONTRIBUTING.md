...
> Instead, [use the security reporting functionality](https://github.com/wize-ai/wize-ai/security) and ensure you comply with the outlined requirements.
...
1. Open a discussion regarding your ideas [here](https://github.com/wize-ai/wize-ai/discussions/new/choose).
...
Help expand our documentation by submitting issues and PRs on our [Docs Repository](https://github.com/wize-ai/docs).
