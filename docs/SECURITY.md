...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on wize-ai.
...
If you want to report a vulnerability and can meet the outlined requirements, [open a vulnerability report here](https://github.com/wize-ai/wize-ai/security/advisories/new).
...
- **Documentation issues/improvement ideas:** Open an issue on our [Documentation Repository](https://github.com/wize-ai/docs)
- **Feature requests:** Create a discussion in [GitHub Discussions - Ideas](https://github.com/wize-ai/wize-ai/discussions/) to discuss with the community if this feature request is wanted by multiple people
...
- **General issues:** Use our [Issue Tracker](https://github.com/wize-ai/wize-ai/issues)
...
For any other immediate concerns, please create an issue in our [issue tracker](https://github.com/wize-ai/wize-ai/issues) or contact our team on [Discord](https://discord.gg/5rJgQTnV4s).
