...
if ENV == "prod":
    if OLLAMA_BASE_URL == "/ollama" and not K8S_FLAG:
        ...
        OLLAMA_BASE_URL = "http://ollama-service.wize-ai.svc.cluster.local:11434"
...
QDRANT_COLLECTION_PREFIX = os.environ.get("QDRANT_COLLECTION_PREFIX", "wize-ai")
...
PINECONE_INDEX_NAME = os.getenv("PINECONE_INDEX_NAME", "wize-ai-index")
