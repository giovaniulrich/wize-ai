...
# BASE_DIR is the parent of BACKEND_DIR (wize-ai-dev/)
...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "WizeAI")
if WEBUI_NAME != "WizeAI":
    WEBUI_NAME += " (WizeAI)"

WEBUI_FAVICON_URL = "https://wize.ai/favicon.png"
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("wize-ai")}
else:
    try:
...
REDIS_KEY_PREFIX = os.environ.get("REDIS_KEY_PREFIX", "wize-ai")
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "wize-ai")
